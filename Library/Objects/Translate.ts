...
export class Translate implements Hittable
{
    ...
    {
        const moved_r = new Ray(substractVector(r.getOrigin,this.offset),r.getDirection);
    ...
    bounding_box(): boolean 
    {
        ...
        Record.Instance.output_box = new aabb(addVector(Record.Instance.output_box.min, this.offset), addVector(Record.Instance.output_box.max, this.offset));
        return true;
    }
